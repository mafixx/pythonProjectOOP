...
# A função uuid4 gera um id randômico, composto de letras e números, separados por hifen.
...
# Criamos a classe PagamentoPorBoleto que herda da classe pagamento.from
